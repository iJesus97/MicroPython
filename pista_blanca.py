	...
	while True:
		...
		if x == 0:
			while True:
				...
				if S1R == 1 and S2R == 0 and S4R == 0 and S5R == 0 and S7R == 0 and S8R == 0:
					PWMA.pulse_width_percent(0)
					PWMB.pulse_width_percent(100)

				elif S1R == 1 and S2R == 1 and S4R == 0 and S5R == 0 and S7R == 0 and S8R == 0:
					PWMA.pulse_width_percent(0)
					PWMB.pulse_width_percent(100)

				elif S1R == 0 and S2R == 1 and S4R == 1 and S5R == 0 and S7R == 0 and S8R == 0:
					PWMA.pulse_width_percent(40)
					PWMB.pulse_width_percent(100)

				elif S1R == 0 and S2R == 1 and S4R == 0 and S5R == 0 and S7R == 0 and S8R == 0:
				...
				elif S1R == 0 and S2R == 0 and S4R == 1 and S5R == 0 and S7R == 0 and S8R == 0:
					PWMA.pulse_width_percent(50)
					PWMB.pulse_width_percent(100)

				elif S1R == 0 and S2R == 0 and S4R == 1 and S5R == 1 and S7R == 0 and S8R == 0:
					PWMA.pulse_width_percent(100)
					PWMB.pulse_width_percent(100)

				elif S1R == 0 and S2R == 0 and S4R == 0 and S5R == 1 and S7R == 1 and S8R == 0:
					PWMA.pulse_width_percent(100)
					PWMB.pulse_width_percent(50)

				elif S1R == 0 and S2R == 0 and S4R == 0 and S5R == 0 and S7R == 1 and S8R == 0:
					PWMA.pulse_width_percent(100)
					PWMB.pulse_width_percent(50)

				elif S1R == 0 and S2R == 0 and S4R == 0 and S5R == 0 and S7R == 1 and S8R == 1:
					PWMA.pulse_width_percent(100)
					PWMB.pulse_width_percent(0)

				elif S1R == 0 and S2R == 0 and S4R == 0 and S5R == 0 and S7R == 0 and S8R == 1:
					PWMA.pulse_width_percent(100)
				...
				elif S1R == 0 and S2R == 0 and S4R == 0 and S5R == 1 and S7R == 0 and S8R == 0:
					PWMA.pulse_width_percent(100)
					PWMB.pulse_width_percent(0)

				elif S1R == 0 and S2R == 0 and S4R == 0 and S5R == 0 and S7R == 0 and S8R == 0:
					PWMA.pulse_width_percent(0)
					PWMB.pulse_width_percent(0)

				elif S1R == 0 and S2R == 1 and S3R == 1 and S4R == 0 and S5R == 0 and S7R == 0 and S8R == 0:
					PWMA.pulse_width_percent(0)
					PWMB.pulse_width_percent(80)

				elif S1R == 0 and S2R == 0 and S4R == 0 and S5R == 0 and S6R == 1 and S7R == 1 and S8R == 0:
					PWMA.pulse_width_percent(80)
					PWMB.pulse_width_percent(0)

				elif S1R == 0 and S2R == 0 and S3R == 1 and S4R == 0 and S5R == 0 and S7R == 0 and S8R == 0:
					PWMA.pulse_width_percent(0)
					PWMB.pulse_width_percent(80)
					LI1.on()
					LI2.on()

				elif S1R == 0 and S2R == 0 and S4R == 0 and S5R == 0 and S6R == 1 and S7R == 0 and S8R == 0:
					PWMA.pulse_width_percent(80)
					PWMB.pulse_width_percent(0)
